...
var instrucciones = ["Move las flechas del teclado para intercabiar las piezas", "Hacelo hasta que logres la misma imagen del Objetivo", "Tenes 50 movimientos"];
...
function ultimoMovimiento(movimiento){
...
function chequearSiGano() {
  ...
  } else if(sumaMovimientosTeclado > 50){
    cartePerdsite();
  }     
}
...
var sumaMovimientosTeclado = 0;

function cantidadMovimientos(nuevomovimiento){ 
  sumaMovimientosTeclado =  sumaMovimientosTeclado + nuevomovimiento;
  mostrarMovimientos = document.getElementById('total-movimientos');
  mostrarMovimientos.textContent = parseInt(sumaMovimientosTeclado);
}
